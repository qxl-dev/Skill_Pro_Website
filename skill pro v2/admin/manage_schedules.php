...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $cid = $_POST['course_id']; $iid = $_POST['instructor_id'];
    $mode = $_POST['mode']; $loc = $_POST['location'];
...
$schedules = $pdo->query("SELECT o.id, c.title, u.full_name, o.mode, o.location, o.start_date, o.end_date
    FROM course_offerings o 
    JOIN courses c ON o.course_id=c.id
    LEFT JOIN users u ON o.instructor_id=u.id")->fetchAll();
?>
